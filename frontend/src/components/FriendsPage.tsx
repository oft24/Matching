...
export default function FriendsPage() {
  ...
  return <section className="mb-8 max-w-6xl mx-auto">
    ...
    {query.trim().length >= 2 && <List title="Resultados en q2play" people={results} empty="No encontramos jugadores con ese nombre." renderAction={(person) => <RequestAction person={person} onSend={sendRequest} onAccept={accept} onRemove={remove} />} />}
